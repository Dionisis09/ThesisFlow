...
- `data/thesisflow.sql`: SQL export δίπλα στην ενεργή βάση, με ολόκληρο το σχήμα, τα δεδομένα και τα indexes.
- `database/thesisflow.sql`: δεύτερο ίδιο αντίγραφο του SQL export για το παραδοτέο.
